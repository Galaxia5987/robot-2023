...
//    public static final Translation2d CUBE_ID1_POSE = CENTER_POSE.plus(new Translation2d(5.8, -2.93659));
    ...
    public static final Translation2d CUBE_ID5_POSE = CENTER_POSE.plus(new Translation2d(-7.24310, 2.93659)).plus(TARGET_ADJUST_OFFSET);
    public static final Translation2d CUBE_ID6_POSE = CENTER_POSE.plus(new Translation2d(-7.24310, 1.26019)).plus(TARGET_ADJUST_OFFSET);
    public static final Translation2d CUBE_ID7_POSE = CENTER_POSE.plus(new Translation2d(-7.24310, -0.41621)).plus(TARGET_ADJUST_OFFSET);
    public static final Translation2d DOUBLE_SUBSTATION_ID8_POSE = CENTER_POSE.plus(new Translation2d(-7.90832, -2.74161)).plus(DOUBLE_SUBSTATION_ADJUST_OFFSET);
