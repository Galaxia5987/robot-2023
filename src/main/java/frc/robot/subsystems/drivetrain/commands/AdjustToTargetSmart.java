...
//
//    public AdjustToTargetSmart(Position position) {
...
//
//        botPose.ifPresent(pose2d -> finalPose = startPose.plus(new Transform2d(pose2d.getTranslation()
//                .minus(position.offset), new Rotation2d())));
//        if(botPose.isPresent()){
//            pose2d -> finalPose = startPose.plus(new Transform2d(pose2d.getTranslation()
//                    .minus(position.offset), new Rotation2d())
//        }
//
...
//                xController.calculate(pose.getX(), finalPose.getX()),
//                yController.calculate(pose.getY(), finalPose.getY()),
